...
import { addDeveloper, fetchDevelopers } from '../../../../store/developersSlice';
import ts from '../../../../services/ToastService';

export default function AddNewDeveloperForm() {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(addDeveloper(formData))
      .unwrap()
      .then(() => {
        console.info('Developer added successfully');
      ...
      .catch((error) => {
        ts.error('Error adding developer:', error.message);
      });
  };
